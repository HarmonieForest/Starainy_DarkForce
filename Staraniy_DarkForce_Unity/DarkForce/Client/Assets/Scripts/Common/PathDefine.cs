...
public class PathDefine 
{
    ...
    public const string NpcGuideImg = "ResImages/npcguide";
    public const string Npc0 = "ResImages/npc0";
    public const string Npc1 = "ResImages/npc1";
    public const string Npc2 = "ResImages/npc2";
    public const string Npc3 = "ResImages/npc3";
    ...
    public const string ItemTokui = "ResImages/toukui";
    ...
    #region 聊天相关
    public const string ImgChatState1 = "ResImages/btntype1";
    public const string ImgChatState2 = "ResImages/btntype2";

    #endregion


    #region PrefabsUI
    public const string TaskItemPrefab = "Prefabs/NormalUI/ItemTask";
    public const string EntityHPItemPrefab = "Prefabs/NormalUI/ItemEntityHP";
    #endregion
}